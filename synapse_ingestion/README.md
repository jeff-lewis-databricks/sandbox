...
The 'synapse_ingestion' project was generated by using the Lakeflow Pipelines template.

* `lib/`: Python source code for this project.
* `lib/shared`: Shared source code across all jobs/pipelines/etc.
* `resources/synapse_ingestion_etl`: Pipeline code and assets for the synapse_ingestion_etl pipeline.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] synapse_ingestion_etl` to your workspace.
...
3. Similarly, to deploy a production copy, type:
   ...
   (defined in resources/synapse_ingestion_etl/synapse_ingestion_job.job.yml). The schedule
